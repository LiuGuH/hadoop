...
import org.apache.hadoop.hdfs.server.federation.router.RouterAsyncNamenodeProtocol;
...
public class TestRouterAsyncNamenodeProtocol extends RouterAsyncProtocolTestBase {
  ...
  public void getBlocks() throws Exception {
    ...
    asyncNamenodeProtocol.getBlocks(dn0, 1024, 0);
    ...
    BlocksWithLocations syncRouterBlockLocations = namenodeProtocol.getBlocks(dn0, 1024, 0);
