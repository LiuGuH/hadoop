...
import org.apache.hadoop.hdfs.server.federation.router.TestRouterRPCClientRetries;
 ...
 */
public class TestRouterAsyncRPCClientRetries {
  ...
  public void setUp() throws Exception {
    ...
    routerConf.setBoolean(RBFConfigKeys.DFS_ROUTER_DN_REPORT_ENABLE_KEY, true);
    routerConf.getBoolean(RBFConfigKeys.DFS_ROUTER_ENABLE_GET_DN_USAGE_KEY, true);
