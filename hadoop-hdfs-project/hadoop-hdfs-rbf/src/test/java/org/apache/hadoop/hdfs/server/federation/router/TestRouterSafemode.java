...
import static org.apache.hadoop.hdfs.server.federation.router.RBFConfigKeys.DFS_ROUTER_SAFEMODE_CHECKINTERVAL_MS;
...
public class TestRouterSafemode {
  ...
  public static void create() throws IOException {
    ...
    conf.setTimeDuration(DFS_ROUTER_SAFEMODE_CHECKINTERVAL_MS,
  ...
  public void testRouterExitSafemode()
    ...
    long interval =
        conf.getTimeDuration(DFS_ROUTER_SAFEMODE_EXTENSION,
            TimeUnit.SECONDS.toMillis(2), TimeUnit.MILLISECONDS) +
        conf.getTimeDuration(DFS_ROUTER_SAFEMODE_CHECKINTERVAL_MS,
            TimeUnit.SECONDS.toMillis(1), TimeUnit.MILLISECONDS);
