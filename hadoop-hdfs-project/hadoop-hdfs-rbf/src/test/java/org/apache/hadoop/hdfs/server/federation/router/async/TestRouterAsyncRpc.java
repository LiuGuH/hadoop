...
public class TestRouterAsyncRpc extends TestRouterRpc {
  ...
  @Test
  public void testGetlistingTrash() throws Exception {
    String src = "/user/hdfs/.Trash/250224160000/tmp/platform_rd_two/mjqv-dapyjgateway-01-1";
    String getlistingSrc = "/user/hdfs/.Trash/250224160000";
    routerProtocol.mkdirs(src, new FsPermission(755), true);
    routerProtocol.getListing(getlistingSrc, HdfsFileStatus.EMPTY_NAME, false);
  }
}
