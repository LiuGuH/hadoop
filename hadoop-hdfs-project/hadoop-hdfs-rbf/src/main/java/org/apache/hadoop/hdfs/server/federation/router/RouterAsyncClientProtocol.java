...
public class RouterAsyncClientProtocol extends RouterClientProtocol {
  ...
  public HdfsFileStatus create(String src, FsPermission masked,
    ...
    AsyncRun tryFunction = () -> {
      ...
      asyncApply((AsyncApplyFunction<RemoteLocation, HdfsFileStatus>) remoteLocation -> {
    ...
    AsyncCatchFunction<Object, IOException> asyncCatchFunction = (o, ioe) -> {
  ...
  public boolean mkdirs(String src, FsPermission masked, boolean createParent)
    ...
    if (locations.size() > 1) {
      ...
      CatchFunction<Object, IOException> catchFunction = (ret, ioe) -> {
      ...
      asyncApply((AsyncApplyFunction<Boolean, Boolean>)ret -> {
        if (!ret) {
          ...
          AsyncRun innerTryFunction = () -> {
            rpcClient.invokeSingle(firstLocation, method, Boolean.class);
          };
          
          CatchFunction<Object, IOException> innerAsyncCatchFuntion = (CatchFunction<Object, IOException>) (o, ioe) -> {
            final List<RemoteLocation> newLocations = checkFaultTolerantRetry(
                method, src, ioe, firstLocation, locations);
            return rpcClient.invokeSequential(
                newLocations, method, Boolean.class, Boolean.TRUE);
          }; 
          asyncTryCatchFinally(innerTryFunction, IOException.class, innerAsyncCatchFuntion, null);
        } else {
          asyncComplete(ret);
        }
      });
      ...
      AsyncCatchFunction<Object, IOException> innerAsyncCatchFuntion = (AsyncCatchFunction<Object, IOException>) (o, ioe) -> {
        final List<RemoteLocation> newLocations = checkFaultTolerantRetry(
            method, src, ioe, firstLocation, locations);
        rpcClient.invokeSequential(
            newLocations, method, Boolean.class, Boolean.TRUE);
  ...
  public DirectoryListing getListing(String src, byte[] startAfter,
    ...
    asyncApply((ApplyFunction<List<RemoteResult<RemoteLocation, DirectoryListing>>, Object>) listings -> {
      ...
      return new Object[]{namenodeListingExists, lastName, new int[]{remainingEntries[0]}};
    });

    asyncApply((AsyncApplyFunction<Object, Object>)  o-> {
      Object[] objArr = (Object[]) o;
      boolean nnlistingExists = (boolean) objArr[0];
      byte[] lastName = (byte[]) objArr[1];
      int[] remainingEntries = (int[]) objArr[2];
        ...
        asyncForEach(children.iterator(), (forEachRun, child) -> {
          if (isTrashPath) {
            getFileInfo(
                ...
                false);
            asyncApply((ApplyFunction<HdfsFileStatus, Object>) o2 -> {
              HdfsFileStatus dir = (HdfsFileStatus) o2;
              if (dir == null) {
            ...
            asyncApply((ApplyFunction<HdfsFileStatus, Object>) dirStatus -> {
              ...
              if (lastName == null) {
                ...
                if (shouldAddMountPoint(bChild,
                    lastName, startAfter, remainingEntries[0])) {
...
//            return nnlistingExists;
            if (!nnlistingExists && nnListing.size() == 0 && children == null) {
  ...
  public DatanodeStorageReport[] getDatanodeStorageReport(
    ...
    asyncApply(
        (ApplyFunction<Map<String, DatanodeStorageReport[]>, DatanodeStorageReport[]>)
  ...
  public void rename2(final String src, final String dst,
    ...
    isMultiDestDirectory(src);
    asyncApply((AsyncApplyFunction<Boolean, Object>) isMultiDestDirectory -> {
      if (isMultiDestDirectory) {
  ...
  public boolean isMultiDestDirectory(String src) throws IOException {
    ...
    CatchFunction<Object, UnresolvedPathException> catchFunction = (o, upe) -> {
      LOG.debug("The destination {} is a symlink.", src);
      return false;
    };
    asyncTryCatchFinally(tryFunction, UnresolvedPathException.class, catchFunction, null);
