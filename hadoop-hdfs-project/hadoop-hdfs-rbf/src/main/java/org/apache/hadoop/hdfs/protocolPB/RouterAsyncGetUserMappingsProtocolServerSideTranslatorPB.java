...
public class RouterAsyncGetUserMappingsProtocolServerSideTranslatorPB
    extends GetUserMappingsProtocolServerSideTranslatorPB {
  private final RouterRpcServer server;

  public RouterAsyncGetUserMappingsProtocolServerSideTranslatorPB(GetUserMappingsProtocol impl) {
    super(impl);
