...
public class RouterAsyncNamenodeProtocolServerSideTranslatorPB
    extends NamenodeProtocolServerSideTranslatorPB {

  private final RouterRpcServer server;
  
  public RouterAsyncNamenodeProtocolServerSideTranslatorPB(NamenodeProtocol impl) {
    super(impl);
  ...
  public GetBlockKeysResponseProto getBlockKeys(
    ...
    asyncRouterServer(() -> server.getBlockKeys(),
        keys -> {
