...
import static org.apache.hadoop.hdfs.server.federation.router.RBFConfigKeys.DFS_ROUTER_MSYNC_AUTO_INTERVAL_MS_DEFAULT;
...
/**
 * The {@link Router} periodically send msync to all nameservices that enable observer.
 */
public class RouterAutoMsyncService extends PeriodicService {
  ...
  protected void serviceInit(Configuration configuration) throws Exception {
    ...
    this.setIntervalMs(conf.getLong(
        ...
        DFS_ROUTER_MSYNC_AUTO_INTERVAL_MS_DEFAULT));
  ...
  public void periodicInvoke() {
    try {
      ...
      LOG.warn("RouterAutoMsyncService msync failed: {}", e.getMessage());
    }
  }

  @Override
  protected void serviceStop() throws Exception {
    LOG.info("Stopping RouterAutoMsyncService.");
    super.serviceStop();
  }
}