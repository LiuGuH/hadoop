...
public class RouterAsyncNamenodeProtocolTranslatorPB extends NamenodeProtocolTranslatorPB {
  private final NamenodeProtocolPB rpcProxy;

  public RouterAsyncNamenodeProtocolTranslatorPB(NamenodeProtocolPB rpcProxy) {
    super(rpcProxy);
    this.rpcProxy = rpcProxy;
  }

  @Override
  public BlocksWithLocations getBlocks(DatanodeInfo datanode, long size, long minBlockSize)
      throws IOException {
    if (!Client.isAsynchronousMode()) {
      return super.getBlocks(datanode, size, minBlockSize);
    }
    GetBlocksRequestProto.Builder builder =
        GetBlocksRequestProto.newBuilder()
            .setDatanode(PBHelperClient.convert((DatanodeID)datanode))
            .setSize(size)
  ...
  public void errorReport(NamenodeRegistration registration, int errorCode,
    ...
    ErrorReportRequestProto req =
        ErrorReportRequestProto.newBuilder()
  ...
  public NamenodeRegistration registerSubordinateNamenode(
    ...
    RegisterRequestProto req =
        RegisterRequestProto.newBuilder()
            .setRegistration(PBHelper.convert(registration))
            .build();
  ...
  public NamenodeCommand startCheckpoint(NamenodeRegistration registration)
    ...
    StartCheckpointRequestProto req =
        StartCheckpointRequestProto.newBuilder()
            .setRegistration(PBHelper.convert(registration))
            .build();
  ...
  public void endCheckpoint(NamenodeRegistration registration,
    ...
    EndCheckpointRequestProto req =
        EndCheckpointRequestProto.newBuilder()
            .setRegistration(PBHelper.convert(registration))
  ...
  public RemoteEditLogManifest getEditLogManifest(long sinceTxId)
    ...
    GetEditLogManifestRequestProto req =
  ...
  public boolean isUpgradeFinalized() throws IOException {
    ...
    IsUpgradeFinalizedRequestProto req =
  ...
  public boolean isRollingUpgrade() throws IOException {
    ...
    IsRollingUpgradeRequestProto req =
