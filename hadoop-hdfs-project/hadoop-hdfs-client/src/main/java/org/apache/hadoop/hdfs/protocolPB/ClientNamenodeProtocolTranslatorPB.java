 ...
 * new PB types.
 * <p>
 * When a new interface is added to a class, it needs to be added 
 * in the subclass {@link org.apache.hadoop.hdfs.protocolPB.RouterAsyncClientProtocolTranslatorPB} as well.
 */
...
public class ClientNamenodeProtocolTranslatorPB implements
  ...
  protected final static RefreshDecomDeadDataNodesRequestProto VOID_REFRESH_DECOMDEADDATANODES_REQUEST =
      RefreshDecomDeadDataNodesRequestProto.newBuilder().build();

  protected final static RefreshTopologyRequestProto VOID_REFRESH_TOPOLOGY_REQUEST =
  ...
  public void refreshDecomDeadDataNodes() throws IOException {
    ipc(() -> rpcProxy.refreshDecomDeadDataNodes(null, VOID_REFRESH_DECOMDEADDATANODES_REQUEST));
  }
