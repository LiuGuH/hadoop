...
public class LegacyFSNamesystemLock implements AbstractFSNamesystemLock {

  private final FSNamesystemLock lock;

  public LegacyFSNamesystemLock(Configuration conf, MutableRatesWithAggregation aggregation) {
