...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public static final long DFS_DATANODE_DATA_TRANSFER_BANDWIDTHPERSEC_DEFAULT =
      1024L*1024*1024*1024; // 1TB
  public static final String DFS_DATANODE_DATA_WRITE_BANDWIDTHPERSEC_KEY =
      "dfs.datanode.data.write.bandwidthPerSec";
  // 1TB
  public static final long DFS_DATANODE_DATA_WRITE_BANDWIDTHPERSEC_DEFAULT = 1024L*1024*1024*1024;
  ...
  public static final String DFS_HEARTBEAT_REREGISTER_INTERVAL_KEY =
      "dfs.heartbeat.reregister.interval";
  public static final long DFS_HEARTBEAT_REREGISTER_INTERVAL_DEFAULT = 9;
  ...
  public static final String DFS_HA_ALLOW_BLANCER_STALE_READ_KEY =
          "dfs.ha.allow.balancer.stale.reads";
  public static final boolean DFS_HA_ALLOW_BLANCER_STALE_READ_DEFAULT = false;
