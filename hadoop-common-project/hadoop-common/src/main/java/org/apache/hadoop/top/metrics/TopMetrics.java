 ...
 */
package org.apache.hadoop.top.metrics;
...
import static org.apache.hadoop.top.window.RollingWindowManager.TopWindow;
...
public class TopMetrics implements MetricsSource {
  ...
  private static void logConf(Configuration conf) {
    LOG.info("NNTop conf: " + CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_BUCKETS_PER_WINDOW_KEY +
        " = " +  conf.get(CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_BUCKETS_PER_WINDOW_KEY));
    LOG.info("NNTop conf: " + CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_NUM_USERS_KEY +
        " = " +  conf.get(CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_NUM_USERS_KEY));
    LOG.info("NNTop conf: " + CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_WINDOWS_MINUTES_KEY +
        " = " +  conf.get(CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_WINDOWS_MINUTES_KEY));
  }
