...
/**
 * This class is for maintaining the various RpcBzlPasswordUpdateMetrics statistics
 * and publishing them through the metrics interfaces.
 */
@InterfaceAudience.Private
@Metrics(about = "Aggregate RpcBzlTokenPasswordFetcher metrics", context = "rpc")
public class RpcBzlTokenPasswordFetcherMetrics {
  static final Logger LOG = LoggerFactory.getLogger(RpcBzlTokenPasswordFetcherMetrics.class);
  final MetricsRegistry registry;
  final String name;

  RpcBzlTokenPasswordFetcherMetrics() {
    name = "RpcBzlTokenPasswordFetcher";
  ...
  public static RpcBzlTokenPasswordFetcherMetrics create() {
    RpcBzlTokenPasswordFetcherMetrics m = new RpcBzlTokenPasswordFetcherMetrics();
    return DefaultMetricsSystem.instance().register(m.name, null, m);
  }

  @Metric("Number of bzlTokenPassword fetch successes")
  ...
  public void incrBzlTokenPasswordFetchSuccesses() {
    bzlTokenPasswordFetchSuccesses.incr();
  }

  public void incrBzlTokenPasswordFetchFailures() {
