...
/**
 * This class is for maintaining the various RpcBzlAuthDataChangeMetrics statistics
 * and publishing them through the metrics interfaces.
 */
@InterfaceAudience.Private
@Metrics(about = "Aggregate RpcBzlTokenPasswordLoader metrics", context = "rpc")
public class RpcBzlTokenPasswordLoaderMetrics {
  static final Logger LOG = LoggerFactory.getLogger(RpcBzlTokenPasswordLoaderMetrics.class);
  final MetricsRegistry registry;
  final String name;

  RpcBzlTokenPasswordLoaderMetrics() {
    name = "RpcBzlTokenPasswordLoader";
  ...
  public static RpcBzlTokenPasswordLoaderMetrics create() {
    RpcBzlTokenPasswordLoaderMetrics m = new RpcBzlTokenPasswordLoaderMetrics();
