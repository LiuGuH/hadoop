...
public final class TopConf {
  ...
  public TopConf(Configuration conf) {
    isEnabled = conf.getBoolean(CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_ENABLED_KEY,
        CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_ENABLED_DEFAULT);
    String[] periodsStr = conf.getTrimmedStrings(
        CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_WINDOWS_MINUTES_KEY,
        CommonConfigurationKeysPublic.RPC_RATELIMITER_TOP_WINDOWS_MINUTES_DEFAULT);
